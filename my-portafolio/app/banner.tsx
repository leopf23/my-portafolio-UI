...
export default function banner() {
  return (
    <div className="scroll-snap-item"> 
      ...
      <text className="tracking-in-contract" id="Leonardo_Perez_Figueroa" data-name="Leonardo Perez Figueroa" transform="translate(522.5 198.055)" fill="#03249c" font-size="27" font-family="OpenSans-Medium, Open Sans" font-weight="500"><tspan x="-159.673" y="0">Leonardo Perez Figueroa</tspan></text>

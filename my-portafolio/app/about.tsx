...
export default function About() {
  ...
  return (
    <div className='text-[1.1rem]'>
      ...
      <div className='absolute right-[90%] top-[650px]'>
         <svg xmlns="http://www.w3.org/2000/svg" width="114" height="117" viewBox="0 0 214 217">
          <g id="Grupo_41" data-name="Grupo 41" transform="translate(0 0.058)">
            <g id="Grupo_36" data-name="Grupo 36" transform="translate(0 -0.425)">
              <g id="Elipse_1" data-name="Elipse 1" transform="translate(129 0.367)" fill="rgba(255,255,255,0)" stroke="#1e86eb" stroke-width="2">
        ...
        <div className='text-gray-500 dark:text-white text-[0.9rem] font-medium md:text-lg mb-2'>
          <span className='text-[#03249C] dark:text-blueText'>HELLO, </span> MY NAME IS
        </div>

        <div className='mb-2 text-[#03249C] dark:text-blueText font-bold md:text-[3.7rem] text-[2rem]'>
         <span>LEONARDO</span>  <span className='text-stroke-1 dark:text-blueText text-white text-stroke-blueText text-stroke-blue scroll-snap-stop-always'>PÉREZ</span>
          <p className='mt-2 md:mt-0 text-[0.9rem] md:text-[1.1rem] font-normal relative bottom-2'>Im, UX / UI Designer and web developer</p>
        </div>

        <div className='mb-5 font-light text-[1rem] text-[#747579] dark:text-white w-[100%] md:w-[90%] xl:w-[60%] leading-8'>
